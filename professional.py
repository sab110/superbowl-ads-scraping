...
ALL_PAGES = [f"{BASE_URL}{i}" for i in range(1, 1432)]
...
for page_url in ALL_PAGES:
    ...
    # Robust load attempt with retries
    ...
    # Each campaign card div has id='campaign_card_*'
...
with open("professional_campaign_urls.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(article_urls))

print(f"✅ Total unique campaigns found: {len(article_urls)} and saved to professional_campaign_urls.txt")
